      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 gap-3 md:gap-4">
          <div>
            ...
            <p className="text-gray-400 text-sm md:text-base">Add, edit, or remove club projects</p>
          </div>
          <button
            onClick={() => {
              resetForm();
                  ...
                  {project.technologies && project.technologies.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.slice(0, 3).map((tech, idx) => (
                        <span key={idx} className="px-2 py-1 bg-cyan-500/10 text-cyan-400 text-xs rounded">
                          {tech}
                        </span>
                      ))}
